...
// Ported from the web app's src/lib/logger.ts (./prisma -> ../db). Same
// batched/queued write semantics; the singleton `logger` is reused by the
// jobs inline-AI routes for enrichment logging.
